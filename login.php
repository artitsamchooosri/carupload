...
{
    header("Location: ".$results['role']."/index.php");
}
...
if(!empty($_POST['email']) && !empty($_POST['password']))
{
    ...
    $records = $conn->prepare('SELECT idx,email,password,role FROM users WHERE email = :email');
...
<html>
  ...
  <body>
      ...
      <div class="header">
          ...
          <a href="user/index.php">Web App</a>
